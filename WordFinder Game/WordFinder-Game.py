...
def compPlayHand(hand, wordList, n):
    ...
    while calculateHandlen(hand) > 0:
        ...
        # If there is no word given, break the loop:
        if word == None:
        ...
        # Otherwise 
            ...
            # Tell the computer how many points the word earned, and the updated total score, in one line followed by a blank line
                scoreNow = getWordScore(word, n)
                totalScore += scoreNow
                print('"%s" earned %s points. Total: %s points.' % (word, scoreNow, totalScore))
                print
                # Update the hand 
...
def playGame(wordList):
    ...
    iter = 0
    while move != "e":
        move = raw_input("Enter n to deal a new hand, r to replay the last hand, "
